    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="mb-0 text-white">Edit Translation</h4>
            </div>
            <form name="translationAddForm" id="translationAddForm" method="post" action="{{backUrl('translation/update')}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" name="module_id" id="module_id" data-placeholder="Choose a Module" tabindex="1">
                                ...
                                <option value="{{$modulesVal->id}}" {{(isset($data->modules->id) && ($data->modules->id == $modulesVal->id))?"selected=selected":""}}>{{$modulesVal->name}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
