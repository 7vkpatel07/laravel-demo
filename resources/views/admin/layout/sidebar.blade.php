            ...
            <ul id="sidebarnav">
                <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="{{backUrl('logout')}}"><i class="fa fa-power-off"></i> {{translate('Logout')}}</a></li>
                    </ul>
                </li>
                ...
                <li> <a class="waves-effect waves-dark" href="{{backUrl('user')}}" aria-expanded="false"><i class="fas fa-users text-danger"></i><span class="hide-menu">{{translate('User Management')}}</span></a></li>

                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false" style="white-space: nowrap;"><i class="fas fa-users text-success"></i><span class="hide-menu">{{translate('People Management')}}</span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-cog text-success"></i><span class="hide-menu">{{translate('Settings')}} </span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{backUrl('module')}}" aria-expanded="false"><i class="far fa-file text-danger"></i><span class="hide-menu">Modules</span></a></li>
                        <li> <a class="waves-effect waves-dark" href="{{backUrl('translation')}}" aria-expanded="false"><i class="fas fa-globe text-success"></i><span class="hide-menu">Translation</span></a></li>
                        <li> <a class="waves-effect waves-dark" href="{{backUrl('settings')}}" aria-expanded="false"><i class="fas fa-cog text-success"></i><span class="hide-menu">Site Setting</span></a></li> -->
