                        ...
                        <li class="nav-item">
                            <div class="language-picker">
                                <select name="language_id" id="language_id">
                                   @php $languageBar = getLanguages();@endphp
                                  <option value="0" {{(currentLanguage() == 0)?"selected=selected":""}}>English</option>
                                    @if(isset($languageBar) && !empty($languageBar))
                                    @foreach($languageBar as $languageBarVal)
                                    <option value="{{$languageBarVal->id}}" {{(currentLanguage() == $languageBarVal->id)?"selected=selected":""}}>{{$languageBarVal->language_name}}</option>
                                     @endforeach
                                    @endif
                                </select>
                            </div>
                       ...
                       <!--  <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                @endif
                                <span class="hidden-md-down">{{displayName()}} &nbsp; <i class="fa fa-angle-down"></i>
                                </span> 
                            </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <!-- text-->
                                <a href="javascript:void(0)" class="dropdown-item"><i class="ti-user"></i> {{translate('My Profile')}}</a>
                                <!-- text-->
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="{{backUrl('logout')}}" class="dropdown-item"><i class="fa fa-power-off"></i> {{translate('Logout')}}</a>
                                <!-- text-->
                            </div>
                        </li>
